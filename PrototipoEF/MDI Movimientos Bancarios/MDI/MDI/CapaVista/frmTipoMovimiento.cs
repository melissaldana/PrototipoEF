...
namespace CapaVista
{
    public partial class frmTipoMovimiento : Form
    {
        ...
        public frmTipoMovimiento()
        {
            ...
            navegador1.idAplicacion = "103";//en la nueva se usara el nombre
            ...
            navegador1.funLlenarComboControl(cmbCuenta, "cuentacontable", "pkIdCuentaContable", "tipoCuenta", "estado");
        ...
        public void funActualizarUsuario(string user)
        {
            ...
            navegador1.aplicacion = "Mantenimiento Tipo de Movimiento";
        ...
        {
            navegador1.funComboTextboxVista(cmbCuenta, txtCombo);
        }
        ...
        {
            navegador1.funTextboxComboVista(cmbCuenta, txtCombo);
        }
