...
namespace CapaVista
{
    public partial class frmCuentaContable : Form
    {
        ...
        public frmCuentaContable()
        {
            ...
            navegador1.funAsignarAliasVista(alias, "cuentacontable", "hotelSanCarlos");
            ...
            navegador1.idAplicacion = "102";//en la nueva se usara el nombre
        ...
        public void funActualizarUsuario(string user)
        {
            ...
            navegador1.aplicacion = "Mantenimiento CuentaContable";//nombre de la app en seguridad
